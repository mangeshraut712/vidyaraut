    ...
    return (
        <section id="game" className="py-24">
            <div className="container mx-auto px-4">
                ...
                >
                    <Card className="border border-border/50 shadow-2xl overflow-hidden hover:border-primary/50 hover:shadow-xl hover:shadow-primary/5 transition-all duration-200">
